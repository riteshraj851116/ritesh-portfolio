      ...
      milestones: [
        {
          ...
          inst: "Galgotias University, Greater Noida (CGPA: 6.72/10)",
          highlight: "Core: DSA, OOP, DBMS, Computer Networks, and Full-Stack Systems.",
        },
        {
          year: "2025",
          title: "MERN Stack Web Development Course",
          inst: "CodeHelp (Love Babbar)",
          highlight: "150+ hours: React, Node.js, Express.js, MongoDB, REST APIs, Auth & Security.",
        },
        {
          year: "2025",
          title: "Data Structures & Algorithms in Java",
          inst: "Apna College",
          highlight: "200+ problems: Arrays, Linked Lists, Trees, Graphs, DP, and Big-O optimization.",
        },
        {
          year: "2021 - 2023",
          title: "Senior Secondary (Class XII) — CBSE",
          inst: "Vikas Vidyalaya, Begusarai, Bihar (68.4%)",
          highlight: "Physics, Chemistry, and Mathematics foundational analytical focus.",
        },
        {
          year: "2021",
          title: "Secondary School (Class X) — CBSE",
          inst: "DAV HFC Barauni, Begusarai, Bihar (77.2%)",
          highlight: "Foundational mathematics and science computing fundamentals.",
        },
      ],
