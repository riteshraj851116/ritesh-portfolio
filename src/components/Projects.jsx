...
const projectsData = [
  ...
  },
  {
    ...
    number: "03",
    name: "CINEAI",
    subtitle: "INTELLIGENT CINEMA & AI BOOKING PLATFORM",
    category: "AI TICKETING & ACOUSTIC CALIBRATION",
    badge: "MERN & WEB SPEECH API",
    year: "2026",
    tagline: "AI-driven cinema booking with Dolby Atmos acoustic sweet spot calibration & Web Speech concierge.",
    description:
      "A production-grade cinema ticketing platform featuring an acoustic sweet spot algorithm calculating optimal seats based on auditorium geometry, audio calibration (Dolby Atmos), and viewing angles. Features a voice-driven AI cinema concierge using Web Speech API, a 4-stage booking pipeline with gourmet in-seat dining pre-orders, and cryptographic digital passes with scannable QR codes.",
    tech: ["React.js", "Node.js", "Express.js", "MongoDB", "Web Speech API", "REST APIs", "Tailwind CSS", "Vite"],
    highlights: [
      "AI Acoustic Sweet Spot calibration algorithm optimizing seats based on Dolby Atmos sound & viewing angles",
      "Interactive conversational cinema concierge with real-time speech recognition & synthesis via Web Speech API",
      "4-step booking pipeline: dynamic seat mapping, gourmet concessions pre-ordering, coupon validation, and QR passes",
      "Resilient Express.js REST APIs with database failover guardrails ensuring zero-latency response times",
    ],
    metrics: { "Acoustics": "Dolby Atmos", "Voice AI": "Web Speech API", "Booking Flow": "4-Stage Pipeline", "Security": "256-Bit QR Pass" },
    accentColor: "#e50914",
    liveUrl: "https://cineai-pi-steel.vercel.app/",
    githubUrl: "https://github.com/riteshraj851116/cineai",
    terminalCode: {
      framework: "Express.js / Node.js",
      speechEngine: "Web Speech API (STT/TTS)",
      query: "calculateOptimalSeats({ rows, acousticProfile: 'ATMOS' })",
      health: "200 OK — Production Live",
    },
  },
];
